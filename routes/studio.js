...
router.get('/studios/:studioId',[auth.isBoth, auth.isGuest],controller.getParticularStudioDetails);
...
router.get('/studios-all',[auth.isBoth, auth.isGuest],controller.getStudios);
...
router.get('/studios',[auth.isBoth, auth.isGuest], controller.getAllStudios);
 ...
 *         description: Some server error, enter valid mongo object ID
*/
router.post('/near-studios',[auth.isUser, auth.isGuest],controller.getAllNearStudios);
