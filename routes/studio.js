...
// NR
// router.post('/studios/updatestudiophotourls',controller.updateStudioPhotoUrls);
// router.post('/studios/updatestudioroomphotourl',controller.updateStudioRoomPhotoUrl);
// router.post('/studios/updatestudioteamphotourl',controller.updateStudioTeamPhotoUrl);
