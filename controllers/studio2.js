...
const GEO_API_FY = process.env.GEO_API_FY;
...
exports.createNewStudio = async (req, res, next) => {
    ...
    // https://api.geoapify.com/v1/geocode/search?text=1214-1224%20West%20Van%20Buren%20Street%2C%20Chicago%2C%20IL%2060607%2C%20United%20States%20of%20America&lang=en&limit=5&format=json&apiKey="+mapQuestKey+""

    // axios.get("https://api.geoapify.com/v1/geocode/search?text="+address+"&apiKey="+GEO_API_FY+"")
...
// exports.updateStudioPhotoUrls = async (req,res,next)=>{

//     const dbdata = await Studio.updateStudioPhotoUrl()
...
// exports.updateStudioRoomPhotoUrl = async (req,res,next)=>{

//     const dbdata = await Studio.updateStudioRoomPhotoUrl()
//     return res.json({ status:true,data:{
//         "data":dbdata
//     }});
...
// exports.updateStudioTeamPhotoUrl = async (req,res,next)=>{

//     const dbdata = await Studio.updateStudioTeamPhotoUrl()
//     return res.json({ status:true,data:{
//         "data":dbdata
//     }});
